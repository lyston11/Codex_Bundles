...
name: tvc-director
description: >
  TVC advertising creative director skill for brand films, product commercials,
  product hero videos, TVC storyboards, Nano Banana Pro keyframe prompts, and
  Seedance / Jimeng video scripts. Use when the user asks for product ads,
  commercial scripts, brand advertising visuals, TVC concepts, storyboards, or
  帮我做一条产品广告.
---
